...
namespace Fussion::RHI {
    ...
    public:
        ...
        virtual void SetData(void const* data, size_t size, size_t offset) = 0;
        ...
        ///  Retrieves a pointer to the GPU memory allocated for this Vulkan buffer.
        /// \return A pointer to mapped RAM if the buffer is currently host-visible, otherwise nullptr.
        virtual void* GetMappedData() = 0;

        ///  Copies the data from this buffer to the specified image.
