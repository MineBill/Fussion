...
namespace Reflect
{
    ...
    FunctionInfo::FunctionInfo(Type returnType, std::string_view functionName, std::vector<Type> argumentTypes,
                               std::vector<std::string> flags, FunctionInfoPtr functionPtr, void* objectInstance)
        : Property(std::move(returnType), std::string(functionName), PropertyType::Function, std::move(flags), {},
                   objectInstance)
    ...
    FunctionInfo::FunctionInfo(Type returnType, std::string_view functionName, std::vector<Type> argumentTypes,
                               std::vector<std::string> flags, std::vector<MetaProp> propertyMetas,
                               FunctionInfoPtr functionPtr, void* objectInstance)
        : Property(std::move(returnType), std::string(functionName), PropertyType::Function, std::move(flags), {},
                   objectInstance)
          , m_argumentTypes(std::move(argumentTypes))
          , m_functionPtr(functionPtr)
    ...
    EReflectReturnCode FunctionInfo::InternaInvoke(void* returnValue, FunctionInfoArgs functionArgs,
