...
namespace Fussion::RHI {
    VulkanImageView::VulkanImageView(VulkanDevice* device, const VulkanImage* image, const ImageViewSpecification spec)
        : m_Specification(spec)
    {
        ...
        device->SetHandleName(TRANSMUTE(u64, m_Handle), VK_OBJECT_TYPE_IMAGE_VIEW, "Image view for " + image->Specification.Label);
    }
