...
Engin5::VulkanCommandBuffer::VulkanCommandBuffer(VulkanDevice* device, CommandBufferSpecification spec)
{
    Specification = spec;
...
void Engin5::VulkanCommandBuffer::Begin(CommandBufferType type)
{
...
void Engin5::VulkanCommandBuffer::End(const CommandBufferType type)
{
    (void)type;
    VK_CHECK(vkEndCommandBuffer(Handle))
}

void Engin5::VulkanCommandBuffer::Reset()
{
    vkResetCommandBuffer(Handle, {});
}

void Engin5::VulkanCommandBuffer::BeginRenderPass(const Ref<RenderPass> render_pass, Ref<FrameBuffer> frame_buffer)
{
...
void Engin5::VulkanCommandBuffer::EndRenderPass(const Ref<RenderPass> render_pass)
{
...
void Engin5::VulkanCommandBuffer::UseShader(Ref<Shader> const& shader)
{
...
void Engin5::VulkanCommandBuffer::SetScissor(const Vector4 size)
{
...
void Engin5::VulkanCommandBuffer::SetViewport(const Vector2 size)
{
...
void Engin5::VulkanCommandBuffer::Draw(u32 vertex_count, u32 instance_count)
{
    vkCmdDraw(Handle, vertex_count, instance_count, 0, 0);
}

void Engin5::VulkanCommandBuffer::DrawIndexed(u32 vertex_count, u32 instance_count)
{
    (void)vertex_count;
    (void)instance_count;
}

void Engin5::VulkanCommandBuffer::BindBuffer(Ref<Buffer> const& buffer)
{
...
void Engin5::VulkanCommandBuffer::BindResource(Ref<Resource> const& resource, Ref<Shader> const& shader, u32 location)
{
...
void Engin5::VulkanCommandBuffer::BindUniformBuffer(Ref<Buffer> const& buffer, Ref<Resource> const& resource, u32 location)
{
