...
namespace Reflect::Profile
{
    ...
    public:
        ...
        {
            return (std::chrono::time_point_cast<std::chrono::microseconds>(m_StopTimepoint).time_since_epoch() -
                std::chrono::time_point_cast<std::chrono::microseconds>(m_StartTimepoint).time_since_epoch()).count();
        }

        long long GetElapsedTimeMill()
        {
            return (std::chrono::time_point_cast<std::chrono::milliseconds>(m_StopTimepoint).time_since_epoch() -
                std::chrono::time_point_cast<std::chrono::milliseconds>(m_StartTimepoint).time_since_epoch()).count();
        }

        long long GetElapsedTimeSec()
        {
            return (std::chrono::time_point_cast<std::chrono::seconds>(m_StopTimepoint).time_since_epoch() -
                std::chrono::time_point_cast<std::chrono::seconds>(m_StartTimepoint).time_since_epoch()).count();
        }
        ...
        void Stop()
        {
            ...
            auto elapsedTime = std::chrono::time_point_cast<std::chrono::microseconds>(m_StopTimepoint).
