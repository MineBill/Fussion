...
namespace Reflect
{
    ...
    using FunctionInfoPtr = EReflectReturnCode(*)(void* objectPtr, void* returnValue, FunctionInfoArgs& args);
    ...
    public:
        FunctionInfo();
        FunctionInfo(Type returnType, std::string_view functionName, std::vector<Type> argumentTypes,
                     std::vector<std::string> flags, FunctionInfoPtr functionPtr, void* objectInstance);
        FunctionInfo(Type returnType, std::string_view functionName, std::vector<Type> argumentTypes,
                     std::vector<std::string> flags, std::vector<MetaProp> propertyMetas, FunctionInfoPtr functionPtr,
                     void* objectInstance);
        ~FunctionInfo();
    ...
    private:
        EReflectReturnCode InternaInvoke(void* returnValue, FunctionInfoArgs functionArgs,
