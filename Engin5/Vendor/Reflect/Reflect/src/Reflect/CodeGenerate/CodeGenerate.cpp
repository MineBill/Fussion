...
{
    constexpr auto ContainerPrefix = "ReflectObject";
    ...
    void CodeGenerate::Reflect(const Parser::FileParser& parser, const ReflectAdditionalOptions* additionalOptions)
    {
        ...
        //else
        {
            ...
            for (const auto& data : parser.GetAllFileParsedData()) {
                ...
                const std::string hFile = data.FilePath + "/Generated/" + data.FileName +
                    Keys::ReflectFileGeneratePrefix + ".h";
                const std::string cppFile = data.FilePath + "/Generated/" + data.FileName +
                    Keys::ReflectFileGeneratePrefix + ".cpp";
