...
public:
    ...
    static auto asset_registry_path() -> fs::path const& { return s_active_project->m_asset_registry_path; }
    static auto assets_folder_path() -> fs::path const& { return s_active_project->m_assets_folder_path; }
    static auto cache_folder_path() -> fs::path const& { return s_active_project->m_cache_folder_path; }
    static auto scripts_folder_path() -> fs::path const& { return s_active_project->m_scripts_folder_path; }
    static auto logs_folder_path() -> fs::path const& { return s_active_project->m_logs_folder_path; }
